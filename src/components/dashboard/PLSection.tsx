...
export default function PLSection({
  ...
  const rows: PLRow[] = [
    { label: 'Chiffre d\'affaires HT', value: fiscal.totalRevenue, bold: true, positive: true },
    { label: '— Charges directes (refacturables)', value: -fiscal.totalDirectCosts, indent: true },
    { label: '= Marge brute', value: fiscal.totalGrossMargin, pct: fiscal.grossMarginPct, bold: true, separator: true },
